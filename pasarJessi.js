...
//evitando de esta manera un condicional en el código de python
      ...
      var str1 = `{"tipo": "geo","finType": "${finType}","d": "${d || "0.15"}", "M": "${M || "2"}", "rho": "${rho || "1.225"}", "a": "${a || "340"}", "mu": "${mu || "1.7894*10**-5"}", "la": "${la || "2.99"}","lc": "${lc || "0.578"}",
      "b": "${b || "0.66"}","xe": "${xe || "3.40"}","lmaxu": "${lmaxu || "0.1652"}","xcanard": "${xcanard || "0.4538"}","lrd": "${lrd || "0.0827"}","mfuselaje": "${mfuselaje || "51.14"}","mcabeza": "${mcabeza || "4.96"}",
